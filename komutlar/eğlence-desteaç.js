...
exports.run = (client, message) => {   
    ...
    var zuladeste = zuladeste[Math.floor(Math.random(1) * zuladeste.length)]
    const replace  = new Discord.MessageEmbed()
    .setImage("https://s3.eu-central-1.amazonaws.com/images.gamesatis.com/products/images/000/024/678/big/platin-deste.jpg")
    .setAuthor('Zula Deste', zulapng)
    .setDescription(`${zuladeste}`)
    .setFooter(`Desteyi açan (${message.author.username}) Unutma Bunlar Sadece Bir Simülatör Gerçek Hesabına Gelmez | Ceixsa`)
    .setColor("RANDOM")
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['zuladesteaç','desteaç','deste-aç','zula'],
  permLevel: 0
};
exports.help = {
  name: 'zula-deste-aç',
